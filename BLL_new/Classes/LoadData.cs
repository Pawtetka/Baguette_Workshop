...
namespace BLL_new.Classes
{
    public class LoadData
    {
        ...
        public LoadData(BaguetteService baguetteService, BaguetteMaterialService baguetteMaterialService, MaterialService materialService, IUnitOfWork unitOfWork)
        {
